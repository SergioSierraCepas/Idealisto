    ...
    <body>
        ...
        <div>
            <form action="vender.php" method="post" enctype="multipart/form-data">
                <input type="text" name="calle" placeholder="Calle" class="input" required><br>
                <input type="number" name="numero" placeholder="Número" class="input" required><br>
                <input type="number" name="piso" placeholder="Piso" class="input" required><br>
                <input type="text" name="puerta" placeholder="Puerta" class="input" required><br>
                <input type="number" name="cp" placeholder="CP" class="input" required><br>
                <input type="number" name="metros" placeholder="Metros2" class="input" required><br>
                <input type="text" name="zona" placeholder="Localidad" class="input" required><br>
                <input type="float" name="precio" placeholder="Precio" class="input" required><br>
                <input type="hidden" name="tamaño" value="100000">
                <input type="file" name="imagen" class="input" required><br>
            ...
            if (isset($_REQUEST['añadir'])) {
                ...
                # Si supera el límite de tamaño establecido
                    ...
                    elseif ($_FILES['imagen']['error'] == UPLOAD_ERR_FORM_SIZE) {
                        ...
                        $errores = $errores . "<li class='alertas'>El tamaño del fichero supera el límite predeterminado";
                    }
                ...
                # No se ha introducido ningún fichero
                    ...
                    elseif ($_FILES['imagen']['name'] == "") {
                        $nombreFichero = '';
                        $errores = $errores . "<li class='alertas'>Falta insertar una imagen del piso";
                    }

                # El fichero no se ha podido subir al servidor

                    else {
                        $errores = $errores . "<li class='alertas'>No se ha podido subir el fichero";
                    }

                # Errores

                    if (is_numeric($calle) || $calle == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Calle' no puede ser un número.\n";
                    }
                    if (!is_numeric($numero) || $numero == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Número' debe ser numérico." . $numero . "\n";
                    }
                    if (!is_numeric($piso) || $piso == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Piso' debe ser numérico." . $piso . "\n";
                    }
                    if ($puerta == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Puerta' está vacío.\n";
                    }
                    if (!is_numeric($cp) || $cp == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Código postal' debe ser numérico." . $cp . "\n";
                    }
                    if (!is_numeric($metros) || $metros == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Metros2' debe ser numérico." . $metros . "\n";
                    }
                    if (is_numeric($zona) || $zona == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Zona' está vacío.\n";
                    }
                    if (!is_numeric($precio) || $precio == "") {
                        $errores = $errores . "<li class='alertas'>El campo 'Precio' debe ser numérico." . $precio . "\n";
                    }
